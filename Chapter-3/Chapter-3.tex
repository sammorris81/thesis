...
\begin{figure}[htbp]  % code/analysis/simstudy/combine-tables.R
	...
	\caption{Smooth of BS (left) and AUROC (right) by rareness for each sample technique for the GEV link.}
...
\begin{figure}[htbp]  % code/analysis/simstudy/combine-tables.R
	...
	\caption{Smooth of BS (left) and AUROC (right) by rareness for each sample technique for the logistic link.}
...
\begin{figure}[htbp]  % code/analysis/simstudy/combine-tables.R
	...
	\caption{Smooth of BS (left) and AUROC (right) by rareness for each sample technique for the hotspot link.}
