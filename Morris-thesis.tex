...
%%      \cochairII{Chris Cox}
%%
\chair{Dr. Brian J. Reich}
\memberI{Dr. Alyson G. Wilson}
\memberII{Dr. Arnab Maity}
\memberIII{Dr. Adam J. Terando}   % unnecessary if committeesize=3
...
\fancypagestyle{lscapedplain}{%
  ...
  \tikz[remember picture, overlay]
	  \node[xshift=1.35in, yshift=1in, right, rotate=90] at
	  (current page.south west)
	  {\slshape \rightmark};
  \tikz[remember picture, overlay]
	  \node[xshift=1.35in, yshift=-1in, left, rotate=90] at
...
%\usepackage{pagegrid}
%\pagegridsetup{top-left, step=0.25in, arrowlength=1in}
